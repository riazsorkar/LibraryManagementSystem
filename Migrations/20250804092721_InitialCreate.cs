    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SettingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    MaxBorrowDuration = table.Column<int>(type: "int", nullable: false),
                    MaxBorrowLimit = table.Column<int>(type: "int", nullable: false),
                    MaxExtensionLimit = table.Column<int>(type: "int", nullable: false),
                    MaxBookingDuration = table.Column<int>(type: "int", nullable: false),
                    MaxBookingLimit = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CoverImagePath = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    HardCopyAvailable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    SoftCopyAvailable = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    AudioFileAvailable = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "SettingId", "MaxBookingDuration", "MaxBookingLimit", "MaxBorrowDuration", "MaxBorrowLimit", "MaxExtensionLimit", "UpdatedAt" },
                values: new object[] { 1, 7, 3, 14, 5, 1, new DateTime(2025, 8, 4, 9, 27, 19, 496, DateTimeKind.Utc).AddTicks(3670) });
